...
class KITTIDataset(Dataset):
    def __init__(self, cfg, root, is_train=True, transforms=None):
        ...
        if self.split == "train":
            ...
            imageset_txt = os.path.join(root, "ImageSets", "demo.txt")
        else:
        ...
        self.depth_files = self.image_files
    ...
    def __getitem__(self, idx):
        ...
        depth_path = os.path.join(self.depth_dir, self.depth_files[idx]) if self.add_depth else None
        img = Image.open(img_path)
        depth = Image.open(depth_path) if self.add_depth else None
        ...
        if not self.is_train:
            ...
            if self.transforms is not None:
                img, target, depth = self.transforms(img, target, depth)

            return img, target, original_idx, depth
    ...
    def load_annotations(self, idx):
        ...
        with open(os.path.join(self.calib_dir, 'calib_cam_to_cam.txt'), 'r') as csv_file:
